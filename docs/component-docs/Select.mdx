...
<Select width={250} height={34} placeholder="Select a country" />
<div style={{ paddingBottom: "10px" }}></div>
<Select width={280} height={38} placeholder="Select a country" />
<div style={{ paddingBottom: "10px" }}></div>
<Select width={300} height={46} placeholder="Select a country" />
